...
public class SessionTokenService {
    ...
    public String  refreshToken(String token){
        ...
        return makeToken(objToken.username, objToken.uuid, objToken.role);
    }
...
//          Long now =  LocalDateTime.now().atZone(ZoneId.systemDefault()).toInstant().toEpochMilli();
    ...
    public String makeToken(String userName,String uuid, String role ){
        return makeToken(userName, uuid, true , role, "login");
    }
    public String makeToken(String userName, String uuid , Boolean isEnable, String role ){
        return makeToken(userName, uuid, isEnable , role, "register");
    }
    public String makeToken(String userName,String uuid, Boolean isEnable , String role, String action){
